# CLAUDE.md — Second Brain: Knowledge Graph AI
...
| 4 | MCP server — 3 tools callable from Claude Desktop |
...
### When a bug or problem is resolved, Claude MUST:
...
### When Claude encounters something worth knowing about the project, it MUST:
...
> Auto-updated whenever Claude fixes a bug or solves a problem in this project.
...
> Auto-updated by Claude when errors are resolved.

<!-- TEMPLATE (copy when adding a new entry):
### [YYYY-MM-DD] Short Title
**Root cause:** one sentence describing what went wrong
**Rule:** what Claude must do or avoid going forward
